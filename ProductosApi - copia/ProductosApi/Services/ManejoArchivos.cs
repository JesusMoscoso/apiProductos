namespace ProductosApi.Services
{
    public class ManejoArchivos:IManejoArchivos
    {
        ...
        public ManejoArchivos(IWebHostEnvironment env, IHttpContextAccessor httpContextAccessor)
        {
            this.env = env;//obtener ruta
            this.httpContextAccessor = httpContextAccessor;//determinar dominio
        }
